...
export default function HomePage() {
  return (
    <div className="bg-white">
      ...
      {/* ── Hero ── Apple dark + large type, Airbnb centered search */}
      <section
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-28 sm:pb-32 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-200/75 max-w-2xl mx-auto leading-relaxed mb-10">
            Housing, jobs, for sale, rideshares, events — all in one place,<br className="hidden sm:block" /> built exclusively for Hoos.
          </p>

          {/* Airbnb-style prominent search */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-16">
        ...
        {/* Categories — Airbnb scroll chips on mobile, grid on desktop */}
        <section className="space-y-5">
        ...
        {/* Team Matching — clean card, no heavy section */}
        <section>
